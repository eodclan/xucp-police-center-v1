                                ...
                                <div class='page-title-box d-sm-flex align-items-center justify-content-between'>
                                    ...
                                    <div class='page-title-right'>
                                        <ol class='breadcrumb m-0'>
                                            <li class='breadcrumb-item'><a href='/usercp/profile/index.php'>".$_SESSION['xucp_police_uname']['xucp_police_conf_site_name']."</a></li>
...
if(isset($_POST['xucp_submit'])){
        ...
        $user_id = $_SESSION['xucp_police_uname']['secure_first'];
                                            ...
                                            <div class='col-sm order-2 order-sm-1'>
                                                <div class='d-flex align-items-start mt-3 mt-sm-0'>
                                                    ...
                                                    if($select_stmt->rowCount() > 0){
                                                        echo "
                                                            <img src='".htmlentities($avatar['user_avatar'], ENT_QUOTES, 'UTF-8')."' alt='' class='img-fluid rounded-circle d-block'>";
													}		
													echo "
                                                        </div>
                                                    </div>
                                                    ...
                                                    if($select_stmt->rowCount() > 0){
                                                        echo "
                                                            ...
                                                            <p class='text-muted font-size-13'>".format_comment($user_sig['user_sig'])."</p>";
                                                    }
													echo "
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class='pb-3'>
                                                        <div class='row'>
                                                            ...
                                                            if($select_stmt->rowCount() > 0){
                                                                echo "
                                                                    <p class='mb-2'>".format_comment($u_sig['user_sig'])."</p>";
                                                            }
															echo "
                                                                </div>
                                                            </div>
																...
																<div class='card-body'>
																	<div class='row gy-4'>
																		...
																		<div class='col-md-12'>
																			...
																			textbbcode('xucp_user_sig', htmlspecialchars(stripslashes($profile['user_sig'])));
                                                        }
																	echo "
																		</div>
																	</div>
                            ...
                            <div class='col-xl-3 col-lg-4'>
                                <div class='card'>
                                    <div class='card-body'>
                                        ...
                                        if($select_stmt->rowCount() > 0){
                                            echo "
                                            <a href='".htmlentities($portfolio['user_hp'], ENT_QUOTES, 'UTF-8')."' class='list-group-item list-group-item-action'>
                                                <div class='d-flex align-items-center'>
                                                    ...
                                                    <div class='flex-grow-1'>
                                                        <div>
                                                            ...
                                                            <p class='font-size-13 text-muted mb-0'>".htmlentities($portfolio['user_hp'], ENT_QUOTES, 'UTF-8')."</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>";
                                    ...
                                    <div class='card-body'>
                                        ...
                                        if($select_stmt->rowCount() > 0){
                                            ...
                                            <a href='#' class='list-group-item list-group-item-action'>
                                                <div class='d-flex align-items-center'>
                                                    <div class='avatar-sm flex-shrink-0 me-3'>
                                                        <img src='".htmlentities($dc_tag['user_avatar'], ENT_QUOTES, 'UTF-8')."' alt='' class='img-thumbnail rounded-circle'>
                                                    </div>
                                                    <div class='flex-grow-1'>
                                                        <div>
                                                            <h5 class='font-size-14 mb-1'>".htmlentities($dc_tag['username'], ENT_QUOTES, 'UTF-8')."</h5>
                                                            <p class='font-size-13 text-muted mb-0'>".htmlentities($dc_tag['user_dctag'], ENT_QUOTES, 'UTF-8')."</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>";
								...
								<div class='card'>
                                    <div class='card-body'>
                                        <h5 class='card-title mb-3'>".FACTION_RANK."</h5>
                                ...
                                if($select_stmt->rowCount() > 0){
                                        echo "
                                            <a href='#' class='list-group-item list-group-item-action'>
                                                <div class='d-flex align-items-center'>
                                                    <div class='avatar-sm flex-shrink-0 me-3'>
                                                        <i class='mdi mdi-eye-refresh-outline img-thumbnail rounded-circle'></i>
                                                    </div>
                                                    <div class='flex-grow-1'>
                                                        <div>
                                                            <p class='font-size-13 text-muted mb-0'>".htmlentities($ban_tag['user_faction_rank'], ENT_QUOTES, 'UTF-8')."</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>";
