...
{
	if(!isset($_SESSION['xucp_police_uname']['secure_first']) || $_SESSION['xucp_police_uname']['secure_granted'] !== 'granted' || $_SESSION['xucp_police_uname']['xucp_police_conf_site_online'] !== '1') {
                                ...
                                <div class='page-title-box d-sm-flex align-items-center justify-content-between'>
                                    ...
                                    <div class='page-title-right'>
                                        <ol class='breadcrumb m-0'>
                                            <li class='breadcrumb-item'><a href='/usercp/login/index.php'>".$_SESSION['xucp_police_uname']['xucp_police_conf_site_name']."</a></li>
 ...
 * @return void
 */
function site_secure_supleader_check(): void
{
    if(intval($_SESSION['xucp_police_uname']['secure_staff']) < UC_CLASS_CHIEF_OF_POLICE) {
        site_header_nologged(SECURE_SYSTEM);
        site_navi_nologged();
