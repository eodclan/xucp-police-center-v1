...
<html lang='en'>
    <head>
		<!-- ####################################################### -->
		<!-- #   Powered by xUCP Police Center Free V1.1.1         # -->
		<!-- #   Copyright (c) 2022 DerStr1k3r.                    # -->
		<!-- #   All rights reserved.                              # -->
		<!-- ####################################################### -->	
        <meta charset='utf-8' />
        <title>".$_SESSION['xucp_police_uname']['xucp_police_conf_site_name']." | ".$SITESUBTITLE."</title>
        <meta name='viewport' content='width=device-width, initial-scale=1.0'>
		<meta name='generator' content='Powered by xUCP Police Center Free V1.1.1' />
...
echo "
    ...
    <body data-layout-mode='".$_SESSION['xucp_police_uname']['xucp_police_conf_themes']."' data-sidebar='".$_SESSION['xucp_police_uname']['xucp_police_conf_themes']."'>
        <!-- Begin page -->
                    ...
                    <div class='d-flex'>
                        <div class='navbar-brand-box'>
                            <a href='/usercp/dashboard/index.php' class='logo logo-dark'>
                                ...
                                <span class='logo-lg'>
                                    <img src='/themes/default/assets/images/logo-bg.png' alt='' height='24'> <span class='logo-txt'>".$_SESSION['xucp_police_uname']['xucp_police_conf_site_name']."</span>
                                </span>
                            </a>
