                        ...
                        <div class='row'>
                            <div class='col-12'>
                                <div class='page-title-box d-sm-flex align-items-center justify-content-between'>
                                    <h4 class='mb-sm-0 font-size-18'>".ACT_HEADER.": " . $row["file_number"]. "</h4>
                                    <div class='page-title-right'>
                                        <ol class='breadcrumb m-0'>
                                            <li class='breadcrumb-item'><a href='".$_SERVER['PHP_SELF']."'>".$_SESSION['xucp_police_uname']['xucp_police_conf_site_name']."</a></li>
                                            <li class='breadcrumb-item active'>".ACT_HEADER.": " . $row["file_number"]. "</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            try
            {
                if(!isset($errorMsg))
                {
                    ...
                    if($insert_stmt->execute(array(
                        ...
                        header("refresh:2; /factioncp/act/index.php");
                    }
                }
            }
									...
									<form action='".$_SERVER['PHP_SELF']."' method='post' enctype='multipart/form-data'>
										...
										<tr>				  
											<td>
												...
												<div class='input-group'>
													<input type='text' name='xucp_act_others' size='50' maxlength='100' class='form-control' value='" . $row["act_others"]. "' required>
												</div>	
											</td>
										</tr>
										<tr>				  
										...
										<tr>				  
											<td>
												...
												<div class='input-group'>";
                                                    textbbcode('xucp_act_msg', htmlspecialchars(stripslashes($row['act_msg'])));
                                                echo "
												</div>	
											</td>
										</tr>
